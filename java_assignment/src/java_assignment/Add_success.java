...
public class Add_success extends JDialog{
	...
	private void InitGUI() {
		...
		lblTitle = new JLabel("Book is added");
		...
		lblContent3.setBounds(194, 118, 210, 32);
