...
public class Borrow_success extends JDialog{
	...
	private void InitGUI() {
		...
		lblTitle = new JLabel("Book is borrowed");
		...
		lblContent3.setBounds(227, 118, 210, 32);
