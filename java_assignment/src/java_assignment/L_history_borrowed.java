...
public class L_history_borrowed extends JFrame{
	...
	private void InitGUI() {
		...
		btnHistoryBorrowedBook.setBackground(new Color(96, 163, 217));
		btnHistoryBorrowedBook.setColor_white();
		btnHistoryBorrowedBook.setVisible(false);
		...
		Object[] column = {"ID Borrower", "ID Book", "Preview","Name", "Borrow Date", "Initial Expiry Date" , "Renew Date", "Renewed Expiry Date" };
